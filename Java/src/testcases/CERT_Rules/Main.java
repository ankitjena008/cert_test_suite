...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 0) {
            ...
            /*
             * User supplied some class names on the command line, just use those with
             * introspection
             *
             * String classNames[] = { "CWE481_Assigning_instead_of_Comparing__boolean_01",
             * "CWE476_Null_Pointer_Dereference__getProperty_01" }; could read class names
             * from command line or use
            ...
            /*
             * needed to separate these calls into other methods because we were running
             * into the size limit Java has for a single method
             */
            runTestCWE1();
            runTestCWE2();
            runTestCWE3();
    ...
    private static void runTestCWE1() {
        ...
        (new testcases.CERT_Rules.CERT_IDS_01()).runTest("CERT_IDS_01");
        (new testcases.CERT_Rules.CERT_IDS_11()).runTest("CERT_IDS_11");
        (new testcases.CERT_Rules.CERT_IDS_16()).runTest("CERT_IDS_16");
    ...
    private static void runTestCWE2() {
        ...
        (new testcases.CERT_Rules.CERT_OBJ_05()).runTest("CERT_OBJ_05");
        /* END-AUTOGENERATED-JAVA-TESTS-2 */
    }

    private static void runTestCWE3() {
        /* BEGIN-AUTOGENERATED-JAVA-TESTS-3 */
        (new testcases.CERT_Rules.CERT_MET_00()).runTest("CERT_MET_00");
        /* END-AUTOGENERATED-JAVA-TESTS-3 */
    }

    private static void runTestCWE4() {
        /* BEGIN-AUTOGENERATED-JAVA-TESTS-4 */
        (new testcases.CERT_Rules.CERT_SER_01()).runTest("CERT_SER_01");
        (new testcases.CERT_Rules.CERT_SER_12()).runTest("CERT_SER_12");
        /* END-AUTOGENERATED-JAVA-TESTS-4 */
    }

    private static void runTestCWE5() {
        /* BEGIN-AUTOGENERATED-JAVA-TESTS-5 */
        (new testcases.CERT_Rules.CERT_FIO_08()).runTest("CERT_FIO_08");
        /* END-AUTOGENERATED-JAVA-TESTS-5 */
    }

    private static void runTestCWE6() {
        /* BEGIN-AUTOGENERATED-JAVA-TESTS-6 */
        (new testcases.CERT_Rules.CERT_SEC_01()).runTest("CERT_SEC_01");
        (new testcases.CERT_Rules.CERT_SEC_04()).runTest("CERT_SEC_04");
        (new testcases.CERT_Rules.CERT_SEC_05()).runTest("CERT_SEC_05");
